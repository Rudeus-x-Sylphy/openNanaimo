...
internal static class LauncherProfileChecks
{
    public static async Task RunAsync()
    {
        ...
        try
        {
            ...
            Check(second.Level == 60 && second.Experience == CharacterProgression.ExperienceRequiredForLevel(60), "launcher level not applied");
            ...
            Console.WriteLine("LAUNCHER_PROFILE_CHECKS_PASS level=60 hp=2399/2400 mp=4999/5000 attack=3456 defense=789 selina_pet_level=3 inventory=PASS");
        }
