...
function Ensure-ClientCompatibility {
    ...
    $arguments=@($runtime.Prefix)+@($ClientCompatibilityTool,'--source-root',$Root,'--output-root',$ClientCompatibilityOverlay,'--furniture','--revival-display','--dungeon-state','--dungeon7','--overwrite','--apply')
